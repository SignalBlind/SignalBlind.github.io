...
[The paper](https://www.researchgate.net/publication/26676676_Mindblind_Eyes_An_Absence_of_Spontaneous_Theory_of_Mind_in_Asperger_Syndrome).
...
The paper identifies the "Teleological Stance" as functional logical model of systems (people) and that this is a non-mentalistic system which is a foundational layer of human cognition.  NT people eventually supplement this with a "Mentalistic Stance" ([Theory of Mind](Theory%20of%20Mind.md)).
...
1. **ID (Intentionality Detector):** Interprets motion as having goal-directed intent.
2. **EDD (Eye-Direction Detector):** Detects eyes and interprets where they are looking.
3. **SAM (Shared-Attention Mechanism):** Triggers when two people are looking at the same thing (Triadic representation).
4. **ToMM (Theory of Mind Mechanism):** The final processor that represents "epistemic mental states" (believing, thinking, knowing).
...
### [Development and neurophysiology of mentalizing](https://pubmed.ncbi.nlm.nih.gov/12689373/), Frith and Frith
...
- The STS (Superior Temporal Sulcus) – Agency Detection
	...
	- **me:** I think I have the hardware -- I can see these things, I just don't notice, no [Social Salience](Social%20Salience.md)
...
- **Implicit Mentalizing (The "Receiver")**
	- **me:** this is the piece that I am missing via the lack of [Social Salience](Social%20Salience.md) and thus the *automatic interrupt*
