...
See [Functional Cognitive Architecture](Functional%20Cognitive%20Architecture.md) -- I think in terms of logical statements.  I only have [Truth and Facts](Truth%20and%20Facts.md) as input.  People speak and I observe.
...
- _If person A says "I am hungry," then person A requires food._
- _If person B is crying, then person B is experiencing a negative internal state._
...
True Theory of Mind requires **nested mentalizing** (knowing that _you_ know that _they_ know). In propositional logic, every level of nesting adds an exponential layer of complexity:
